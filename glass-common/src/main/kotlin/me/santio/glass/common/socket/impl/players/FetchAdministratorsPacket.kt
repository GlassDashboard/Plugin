...
class FetchAdministratorsPacket: me.santio.glass.common.socket.SocketEvent("FETCH_ADMINISTRATOR_PLAYERS") {

    override fun onEvent(vararg data: Any) {

        val acknowledgement = data[0] as Ack
        val players = me.santio.glass.common.Glass.server.getServerAdministrators()
